...
/**
 * Safely converts numeric values that may arrive from
 * the database/API as numbers or formatted strings.
 *
 * Examples:
 *   1020      -> 1020
 *   "1020"    -> 1020
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <span
                  className={`rounded-full px-4 py-1.5 text-xs font-bold border-2 ${getStatusColor(
                    flock.status ||
                      "Active"
                  )}`}
                >
                ...
                <span
                  className={`rounded-full px-4 py-1.5 text-xs font-bold border-2 ${getBirdTypeColor(
                    flock.bird_type
                  )}`}
                >
                  {flock.bird_type}
...
<KpiCard
  ...
  value={safeNumber(availableBirds)}
/>

<KpiCard
  title="Starting Birds"
  value={safeNumber(flock.quantity)}
/>

            {flock.age_weeks && (
              <KpiCard
                title="Age"
                value={`${flock.age_weeks} ${
                  flock.age_weeks ===
                  1
                    ? "week"
                    : "weeks"
                ...
                {!flock.notes && (
                  <div className="text-center py-12 text-slate-500 text-sm bg-slate-50 rounded-xl border-2 border-dashed border-slate-300">
                    ...
                    <p className="text-xs mt-1">
                      Add notes to keep track of important information about this flock.
                    </p>
